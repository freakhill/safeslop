...
- Force outbound traffic through a proxy with a deny-by-default
  ...
  `examples/squid.conf`. Add a host-level firewall ([LuLu](https://objective-see.org/products/lulu.html)
...
- `examples/tart-brew-sandbox.md`: VM template assumptions for `slop-brew-vm`
